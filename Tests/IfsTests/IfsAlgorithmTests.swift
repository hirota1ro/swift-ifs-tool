...
final class IfsAlgorithmTests: XCTestCase {
    ...
    func testAlgorithmFig2c() {
        ...
        let algorithm = IfsAlgorithm(w: w, start: CGPoint(x:0.01, y:0.01))
        algorithm.process(iterations: 3, plotter: EmptyPlotter())
    }

    func testAlgorithmFig3b() {
